...
- 最后一个产品实现提交：`43b0a193667856aaa695e5fd39fa018732222a39`
...
本轮 reviewer P1 指出 `2c17644` 的 fingerprint 使用 32-bit FNV-1a，碰撞文本 `zcl5rbjm02`/`ak43vzv798` 可得到相同值。`43b0a193667856aaa695e5fd39fa018732222a39` 改用 canonical DOM 文本 UTF-8 的 Web Crypto SHA-256 小写 hex，observation/capture 共享同一实现语义，算法不可用时 fail closed；确定性碰撞回归要求 observation 后改写内容时不得点击 Copy 或进入 capturing。本轮不声明 Review accepted 或 live VER-004 通过。
